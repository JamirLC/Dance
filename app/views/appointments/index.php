...
<head>
    ...
    <style>
        ...
        .container {
            display: flex;
            justify-content: space-between; /* Ensure both items are aligned horizontally */
            gap: 20px;
        ...
        /* Appointments Table */
        .appointments-table {
            width: 48%; /* Adjust width of the table */
        ...
        /* Calendar Styling */
        .calendar-container {
            width: 48%; /* Adjust width of the calendar */
            background-color: #fff;
            border-radius: 8px;
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
            padding: 20px;
        ...
        @media (max-width: 768px) {
            ...
            .appointments-table, .calendar-container {
...
<body>
    ...
    <header>
        <nav>
            <ul>
                <li><a href="/appointments/create">Create Schedule</a></li>
